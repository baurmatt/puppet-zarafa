class zarafa::server (
  ...
  $ssl_protocols = $zarafa::server::params::ssl_protocols,
  $ssl_ciphers = $zarafa::server::params::ssl_ciphers,
  $ssl_prefer_server_ciphers = $zarafa::server::params::ssl_prefer_server_ciphers,
