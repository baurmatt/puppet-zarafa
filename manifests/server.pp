class zarafa::server (
  ...
  $owner_auto_full_access = $zarafa::server::params::owner_auto_full_access,
  ...
  $tmp_path = $zarafa::server::params::tmp_path,
  ...
  $log_buffer_size = $zarafa::server::params::log_buffer_size,
  ...
  $attachment_files_fsync = $zarafa::server::params::attachment_files_fsync,
  ...
  $server_ssl_protocols = $zarafa::server::params::server_ssl_protocols,
  $server_ssl_ciphers = $zarafa::server::params::server_ssl_ciphers,
  $server_ssl_prefer_server_ciphers = $zarafa::server::params::server_ssl_prefer_server_ciphers,
